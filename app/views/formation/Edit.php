...
<body class="flex relative">
    ...
    <section class="flex flex-col p-4 md:p-8 gap-4 md:gap-8 w-screen md:w-[calc(100%-14rem)]">
        <div class="flex align-center justify-between gap-2 h-24">
            <h1 class="place-content-center text-3xl text-gray-700">Modifier <?= $data->cours . ' - ' . $data->formateur ?></h1>
        </div>
        <form method="post" action="/gestion/formation/update" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 ">
                ...
                <label for="mode">
                    ...
                    <select
                        ...
                        name="mode"
                        class="mt-0.5 w-full border-gray-300 px-3 py-2 text-gray-900 shadow-sm sm:text-sm" required>
                        <option value="On-Site" <?= $data->mode == 'On-Site' ? 'selected' : ''; ?>>On-Site</option>
                        <option value="Remote" <?= $data->mode == 'Remote' ? 'selected' : ''; ?>>Remote</option>
                    </select>
                </label>
            </div>
