...
<body class="flex relative">
    ...
    <section class="flex flex-col p-4 md:p-8 gap-4 md:gap-8 w-[calc(100%-14rem)]">
        <div class="flex align-center justify-between gap-2 h-24">
            <h1 class="place-content-center text-3xl text-gray-700">Ajouter un Cours</h1>

        </div>
        <form method="post" action="/gestion/cours/create" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 ">
                ...
                <div class="flex items-center justify-center gap-16 md:gap-24">
                    ...
                    <label
                        ...
                        <input type="checkbox" id="testIncludedCheck" name="testIncluded" class="peer sr-only" />
            ...
            <label for="testContent" id="testContentContainer" class="hidden">
