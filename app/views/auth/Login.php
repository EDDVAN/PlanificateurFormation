    ...
    <section class="flex justify-center items-center h-[calc(100vh_-_4rem)]">
        ...
        <form action="/login" method="post" enctype="multipart/form-data" class="bg-white shadow w-96 divide-y divide-gray-200">
            <div class="px-5 py-7">
                ...
                <input type="text" name="username" class="border px-3 py-2 mt-1 mb-5 text-sm w-full" />
                <label class="font-semibold text-sm text-gray-600 pb-1 block">Password</label>
                <input type="password" name="password" class="border px-3 py-2 mt-1 mb-5 text-sm w-full" />
