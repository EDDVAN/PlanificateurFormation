                    ...
                    ?>
                        <tr class="*:text-gray-900 *:first:font-medium">
                            ...
                            <td class="px-3 py-2 flex flex-col lg:flex-row align-center justify-around gap-2 border-0 w-fit">
                                <a target="_blank" href="/client/formation/view?id=<?= $row->id ?>" class="cursor-pointer flex w-12 justify-center align-center text-sm gap-1 px-2 py-1.5 text-white bg-blue-500">
