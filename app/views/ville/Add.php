...
<body class="flex relative flex-col md:flex-row">
    ...
    <section class="flex flex-col p-4 md:p-8 gap-4 md:gap-8 w-screen md:w-[calc(100%-14rem)]">
        ...
        <form method="post" action="/gestion/ville/create"
            ...
            <label for="pays">
                ...
                <select
                    ...
                    ?>
                        <option value="<?= $row->id ?>"><?= $row->sigle . ' - ' . $row->name ?></option>
                    <?php
                    } ?>
                </select>
            </label>
            ...
            <div class=" flex gap-2 md:gap-4 align-center justify-center md:justify-end">
                <a href="/gestion/ville" class="flex justify-center align-center gap-2  border border-emerald-600 px-4 py-2 text-sm font-medium text-emerald-600 ">
